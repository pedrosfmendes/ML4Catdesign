...
#     epsilon_delta = epsilon_max - epsilon_min
    ...
    for i in range(datapoints):
        ...
        Epsilon = Ae * np.exp(-Eae/R*(1/T-1/T_min))
...
with open(os.path.join(directory, 'CorrArrhenius_100k.pickle'), 'wb') as f:
     pickle.dump(data, f)          

all_results = run_model(data)

with open(os.path.join(directory,'results_corr_arrhenius.pickle'), 'wb') as f:
